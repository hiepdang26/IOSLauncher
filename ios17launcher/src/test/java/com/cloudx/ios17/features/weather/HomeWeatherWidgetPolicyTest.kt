...
class HomeWeatherWidgetPolicyTest {
    @Test
    ...
    @Test
    fun iconTypeFor_mapsOpenMeteoConditionCodes() {
        assertEquals(HomeWeatherIconType.CLOUD, HomeWeatherWidgetPolicy.iconTypeFor(3))
        assertEquals(HomeWeatherIconType.RAIN, HomeWeatherWidgetPolicy.iconTypeFor(61))
        assertEquals(HomeWeatherIconType.SNOW, HomeWeatherWidgetPolicy.iconTypeFor(71))
        assertEquals(HomeWeatherIconType.STORM, HomeWeatherWidgetPolicy.iconTypeFor(95))
    }
