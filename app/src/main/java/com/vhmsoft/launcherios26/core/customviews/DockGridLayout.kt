...
import com.vhmsoft.launcherios26.core.utils.OffsetParent

class DockGridLayout
@JvmOverloads
constructor(private val mContext: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    GridLayout(mContext, attrs, defStyleAttr), com.vhmsoft.launcherios26.core.customviews.Insettable, OffsetParent {
    ...
    private fun applyDockStyle(safeInsets: Rect) {
        val deviceProfile = com.vhmsoft.launcherios26.BlissLauncher.getApplication(mContext).deviceProfile
        val lp = layoutParams as? com.vhmsoft.launcherios26.core.customviews.InsettableRelativeLayout.LayoutParams ?: return
    ...
    private fun applyChildMetrics(deviceProfile: DeviceProfile, dockStyle: DockStylePolicy.Style) {
        val childWidth = DockStylePolicy.childWidthPx(
            style = dockStyle,
            cellWidthPx = deviceProfile.cellWidthPx,
            hotseatCellWidthPx = deviceProfile.hotseatCellWidthPx,
            fullWidthDockCellWidthPx = DockStylePolicy.fullWidthDockCellWidthPx(
                availableWidthPx = deviceProfile.availableWidthPx,
