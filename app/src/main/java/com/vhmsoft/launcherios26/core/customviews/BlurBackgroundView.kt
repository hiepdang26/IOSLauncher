...
import com.vhmsoft.launcherios26.core.blur.BlurDrawable
...
class BlurBackgroundView(context: Context, attrs: AttributeSet?) :
    View(context, attrs), com.vhmsoft.launcherios26.core.customviews.Insettable, BlurWallpaperProvider.Listener {
    ...
    private val blurDrawableCallback by lazy {
        object : Drawable.Callback {
            ...
            override fun invalidateDrawable(who: Drawable) {
                com.vhmsoft.launcherios26.core.runOnMainThread { invalidate() }
            }
