...
public final class sa0 {
    public static final boolean q = ar1.f;
    ...
    public sa0(Context context, xg0 xg0Var, HashSet hashSet, HashMap map, Point point, Point point2) {
    ...
    public static boolean a(sa0 sa0Var, boolean[][] zArr, int i, int i2, int i3, int i4) {
        if (i + i3 <= sa0Var.j && i2 + i4 <= sa0Var.k) {
    ...
    public static void f(boolean[][] zArr, qa0 qa0Var, boolean z) {
        for (int i = qa0Var.k; i < qa0Var.k + qa0Var.m; i++) {
            for (int i2 = qa0Var.l; i2 < qa0Var.l + qa0Var.n; i2++) {
                zArr[i][i2] = z;
            }
        }
    }
    ...
    public static boolean g(Context context) {
        ...
        if (strE.equals(sharedPreferencesQ.getString("migration_src_workspace_size", "")) && strE2.equals(sharedPreferencesQ.getString("migration_src_hotseat_size", ""))) {
            return true;
        }
        ...
        try {
            try {
                ...
                hashSet2.addAll(p02.l(context).D().keySet());
                Point pointJ2 = j(sharedPreferencesQ.getString("migration_src_hotseat_size", strE2));
                if (pointJ2.x == i3 && pointJ2.y == i4) {
                    hashSet = hashSet2;
                    zH = false;
                } else {
                    hashSet = hashSet2;
                    zH = new sa0(context, jk0.a().e, hashSet, pointJ2.x, xg0Var.k, xg0Var.l).h();
                }
                point = new Point(xg0Var.d, i2);
                pointJ = j(sharedPreferencesQ.getString("migration_src_workspace_size", strE));
            } catch (Exception unused) {
            }
            if (!point.equals(pointJ)) {
                ...
                int iIndexOf = arrayList.indexOf(pointJ);
                int iIndexOf2 = arrayList.indexOf(point);
                if (iIndexOf <= -1 || iIndexOf2 <= -1) {
                    throw new Exception("Unable to migrate grid size from " + pointJ + " to " + point);
                }
                HashMap map = new HashMap();
                Context context2 = context;
                Iterator<String> it2 = context2.getSharedPreferences("com.luutinhit.launcher6.prefs", 0).getStringSet("migration_widget_min_size", Collections.EMPTY_SET).iterator();
                while (it2.hasNext()) {
                ...
                while (iIndexOf2 < iIndexOf) {
                    int i5 = iIndexOf2;
                    HashMap map2 = map;
                    if (new sa0(context2, jk0.a().e, hashSet, map2, (Point) arrayList.get(iIndexOf), (Point) arrayList.get(iIndexOf - 1)).i()) {
                        zH = true;
                    }
                    iIndexOf--;
                    context2 = context;
                ...
                System.currentTimeMillis();
                sharedPreferencesQ.edit().putString("migration_src_workspace_size", strE).putString("migration_src_hotseat_size", strE2).remove("migration_widget_min_size").apply();
                return false;
            }
            if (zH) {
                Cursor cursorQuery = context.getContentResolver().query(wl0.a, null, null, null, null);
    ...
    public final boolean b() throws RemoteException, OperationApplicationException {
        ArrayList<ContentProviderOperation> arrayList = this.e;
        boolean zIsEmpty = arrayList.isEmpty();
        Context context = this.a;
        if (!zIsEmpty) {
            context.getContentResolver().applyBatch("com.luutinhit.launcherios.settings", arrayList);
        }
        ArrayList arrayList2 = this.d;
        if (!arrayList2.isEmpty()) {
            TextUtils.join(", ", arrayList2);
            context.getContentResolver().delete(wl0.a, ar1.d("_id", arrayList2), null);
        }
        return (arrayList.isEmpty() && arrayList2.isEmpty()) ? false : true;
    }

    public final int d(long j) {
        Cursor cursorQuery = this.a.getContentResolver().query(wl0.a, new String[]{"_id", "intent"}, uo.f("container = ", j), null, null, null);
        int i = 0;
        while (cursorQuery.moveToNext()) {
            try {
                l(cursorQuery.getString(1));
                i++;
            } catch (Exception unused) {
                this.d.add(Long.valueOf(cursorQuery.getLong(0)));
            }
        }
        cursorQuery.close();
        return i;
    ...
    public final boolean h() {
        Cursor cursorQuery = this.a.getContentResolver().query(wl0.a, new String[]{"_id", "itemType", "intent", "screen"}, "container = -101", null, null, null);
        int columnIndexOrThrow = cursorQuery.getColumnIndexOrThrow("_id");
        int columnIndexOrThrow2 = cursorQuery.getColumnIndexOrThrow("itemType");
        ...
        while (true) {
            ...
            if (!zMoveToNext) {
                ...
                while (true) {
                    ...
                    qa0 qa0Var = (qa0) arrayList.get(arrayList.size() / 2);
                    int size = arrayList.size();
                    while (i2 < size) {
                        Object obj = arrayList.get(i2);
                        i2++;
                        qa0 qa0Var2 = (qa0) obj;
                        if (qa0Var2.x < qa0Var.x) {
                            qa0Var = qa0Var2;
                        }
                    }
                    arrayList2.add(Long.valueOf(qa0Var.g));
                ...
                while (i4 < size2) {
                    ...
                    int i5 = i3 + 1;
                    i3 = i5 == this.p ? i3 + 2 : i5;
                }
                return b();
            }
            qa0 qa0Var4 = new qa0();
            qa0Var4.g = cursorQuery.getLong(columnIndexOrThrow);
            qa0Var4.h = cursorQuery.getInt(columnIndexOrThrow2);
            long j2 = cursorQuery.getLong(columnIndexOrThrow4);
            qa0Var4.j = j2;
            if (j2 >= this.n) {
                arrayList2.add(Long.valueOf(qa0Var4.g));
            } else {
                try {
                    int i6 = qa0Var4.h;
                    if (i6 == 0 || i6 == 1) {
                        l(cursorQuery.getString(columnIndexOrThrow3));
                        qa0Var4.x = qa0Var4.h == 1 ? 1.0f : 0.8f;
                    } else {
                        if (i6 != 2) {
    ...
    /* JADX WARN: Type update failed for variable: r31v24 ??, new type: int
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 13491. Try increasing type updates limit count.
    ...
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 13491. Try increasing type updates limit count.
    	...
    	at jadx.core.dex.visitors.typeinference.FixTypesVisitor.visit(FixTypesVisitor.java:94)
     */
    /* JADX WARN: Type update failed for variable: r31v25 ??, new type: int
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 13491. Try increasing type updates limit count.
    	at jadx.core.dex.visitors.typeinference.TypeUpdateInfo.requestUpdate(TypeUpdateInfo.java:37)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.requestUpdate(TypeUpdate.java:224)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.updateTypeForSsaVar(TypeUpdate.java:197)
    ...
    */
    public final boolean i() throws java.lang.Exception {
        /*
            Method dump skipped, instruction units count: 1349
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sa0.i():boolean");
    }

    public final void k(qa0 qa0Var) {
        ContentValues contentValues = this.c;
        contentValues.clear();
        contentValues.put("screen", Long.valueOf(qa0Var.j));
        contentValues.put("cellX", Integer.valueOf(qa0Var.k));
        contentValues.put("cellY", Integer.valueOf(qa0Var.l));
        contentValues.put("spanX", Integer.valueOf(qa0Var.m));
        contentValues.put("spanY", Integer.valueOf(qa0Var.n));
        this.e.add(ContentProviderOperation.newUpdate(wl0.a(qa0Var.g)).withValues(contentValues).build());
    }
    ...
    public final void l(String str) throws Exception {
        ...
        if (component != null) {
            if (!hashSet.contains(uri.getComponent().getPackageName())) {
                throw new Exception("Package not available");
            }
        } else if (uri.getPackage() != null && !hashSet.contains(uri.getPackage())) {
            throw new Exception("Package not available");
        }
    }

    public sa0(Context context, xg0 xg0Var, HashSet hashSet, int i, int i2, int i3) {
        this.b = new HashMap();
        this.c = new ContentValues();
        this.d = new ArrayList();
        this.e = new ArrayList();
