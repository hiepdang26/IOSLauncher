...
public final class uu1 {
    ...
    static {
        float[] fArr = n90.c;
        float fH = (float) ((((double) n90.H()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = n90.a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float f10 = 1.0f / ((5.0f * fH) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(((double) fH) * 5.0d))) + (f11 * fH);
        float fH2 = n90.H() / fArr[1];
        double d2 = fH2;
        ...
        k = new uu1(fH2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public uu1(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
