...
public final class pc1 extends Drawable {
    public float a;
    ...
    public pc1(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(qc1.a(this.e, this.a, this.g)), (int) Math.ceil(qc1.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
