...
public final class wr {
    ...
    static {
        ka0.r("Data");
        wr wrVar = new wr(new HashMap());
        c(wrVar);
        b = wrVar;
    }

    public wr(wr wrVar) {
        this.a = new HashMap(wrVar.a);
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    public static defpackage.wr a(byte[] r5) {
        /*
            int r0 = r5.length
        ...
        L50:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wr.a(byte[]):wr");
    }

    public static byte[] c(wr wrVar) throws Throwable {
        ...
        try {
            objectOutputStream.writeInt(wrVar.a.size());
            for (Map.Entry entry : wrVar.a.entrySet()) {
