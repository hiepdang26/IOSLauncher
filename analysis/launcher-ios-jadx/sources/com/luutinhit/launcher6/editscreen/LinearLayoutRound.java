...
public class LinearLayoutRound extends LinearLayout {
    public float g;
    public float h;
    public float i;
    public float j;
    ...
    public LinearLayoutRound(Context context, AttributeSet attributeSet) {
        ...
        this.t = true;
        this.u = true;
        this.w = new hi(1, this);
        int color = -2565928;
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, g71.LinearLayoutRound);
            ...
            this.t = typedArrayObtainStyledAttributes.getBoolean(g71.LinearLayoutRound_isSquare, false);
            this.u = typedArrayObtainStyledAttributes.getBoolean(g71.LinearLayoutRound_isSlidingBackground, false);
            this.p = typedArrayObtainStyledAttributes.getBoolean(g71.LinearLayoutRound_roundTopLeft, true);
            this.q = typedArrayObtainStyledAttributes.getBoolean(g71.LinearLayoutRound_roundTopRight, true);
            this.r = typedArrayObtainStyledAttributes.getBoolean(g71.LinearLayoutRound_roundBottomLeft, true);
            this.s = typedArrayObtainStyledAttributes.getBoolean(g71.LinearLayoutRound_roundBottomRight, true);
            color = typedArrayObtainStyledAttributes.getColor(g71.LinearLayoutRound_backgroundColor, -2565928);
        }
        setWillNotDraw(false);
        setBackgroundColor(color);
        Paint paint = new Paint(1);
        this.l = paint;
        paint.setColor(1062228048);
        this.v = new Path();
    }
    ...
    public final void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (!this.t) {
            if (this.i != Math.min(this.g, this.h) / 2.0f) {
                path.addPath(a(this.g, this.h, this.i, this.p, this.q, this.r, this.s));
                return;
            }
        ...
        float f5 = this.g;
        if (f4 != f5 / 2.0f) {
            path.addPath(a(f5, f5, f4, this.p, this.q, this.r, this.s));
            return;
        }
    ...
    public void setDarkModeTransparentBackground(boolean z) {
        setBackgroundColor(z ? -1726211044 : -1713447202);
        invalidate();
    }
