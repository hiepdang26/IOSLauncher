...
public class AppBarLayout$BaseBehavior<T> extends et1 {
    public boolean b;
    public int d;
    ...
    */
    ...
    @Override // defpackage.et1, defpackage.mo
    public /* synthetic */ boolean g(CoordinatorLayout coordinatorLayout, View view, int i) {
    ...
    @Override // defpackage.mo
    public /* synthetic */ void j(CoordinatorLayout coordinatorLayout, View view, View view2, int i, int i2, int[] iArr, int i3) {
        throw new ClassCastException();
    }
    ...
    @Override // defpackage.mo
    public /* synthetic */ boolean p(CoordinatorLayout coordinatorLayout, View view, View view2, View view3, int i, int i2) {
        throw new ClassCastException();
    }

    @Override // defpackage.mo
    public /* synthetic */ void q(CoordinatorLayout coordinatorLayout, View view, View view2, int i) {
        throw new ClassCastException();
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean r(android.view.View r6, android.view.MotionEvent r7) {
        /*
            r5 = this;
        ...
        L65:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.appbar.AppBarLayout$BaseBehavior.r(android.view.View, android.view.MotionEvent):boolean");
    }
