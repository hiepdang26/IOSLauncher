...
public final class zzbbw {
    ...
    static {
        ...
        zzh = zzbbn.zzg(1, "gads:video_exo_player:exo_player_precache_limit", ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
        zzi = zzbbn.zzg(1, "gads:video_exo_player:byte_buffer_precache_limit", ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
        ...
        zzeA = zzbbn.zzg(1, "gads:omid:destroy_webview_delay", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
        ...
        zzfc = zzbbn.zzg(1, "gads:uri_query_to_map_bg_thread:min_length", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
        ...
        zzgP = zzbbn.zzg(1, "gads:native_ads_signal:timeout", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
        ...
        zzhb = zzbbn.zzg(1, "gads:interscroller:min_width", t.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT, t.EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT);
        ...
        zzhS = zzbbn.zzg(1, "gads:cui_buffer_size", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
        ...
        zzic = zzbbn.zzg(1, "gads:inspector:max_ad_life_cycles", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
        zzid = zzbbn.zzg(1, "gads:inspector:ui_invocation_millis", 2000, 2000);
        ...
        zzin = zzbbn.zzg(1, "gads:inspector:icon_width_px", MotionScene.Transition.TransitionOnClick.JUMP_TO_END, MotionScene.Transition.TransitionOnClick.JUMP_TO_END);
        zzio = zzbbn.zzg(1, "gads:inspector:icon_height_px", MotionScene.Transition.TransitionOnClick.JUMP_TO_END, MotionScene.Transition.TransitionOnClick.JUMP_TO_END);
        ...
        zziI = zzbbn.zzg(1, "gads:max_timeout_view_click_ms", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
        ...
        zzjt = zzbbn.zzg(1, "gads:attr_reporting_timeout_duration_millis", zzbbc.zzq.zzf, zzbbc.zzq.zzf);
