...
public final class zzaon {
    public static X509Certificate[][] zza(String str) throws Throwable {
        ...
        try {
            pairZzc = zzaoo.zzc(randomAccessFile2);
        } catch (Throwable th) {
            th = th;
        ...
        try {
            if (pairZzc == null) {
                throw new zzaok("Not an APK file: ZIP End of Central Directory record not found in file with " + randomAccessFile2.length() + " bytes");
            }
            ...
            if (j2 < byteBufferAllocate.capacity() || j2 > 2147483639) {
                throw new zzaok("APK Signing Block size out of range: " + j2);
            }
            int i = (int) (8 + j2);
            long j3 = jZza - ((long) i);
            if (j3 < 0) {
                throw new zzaok("APK Signing Block offset out of range: " + j3);
            }
            ...
            if (j4 != j2) {
                throw new zzaok("APK Signing Block sizes in header and footer do not match: " + j4 + " vs " + j2);
            }
            ...
            try {
                ...
                while (byteBufferSlice.hasRemaining()) {
                    ...
                    if (j5 < 4 || j5 > 2147483647L) {
                        throw new zzaok("APK Signing Block entry #" + i2 + " size out of range: " + j5);
                    }
                    int i3 = (int) j5;
                    int iPosition2 = byteBufferSlice.position() + i3;
                    if (i3 > byteBufferSlice.remaining()) {
                        throw new zzaok("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + byteBufferSlice.remaining());
                    }
                    if (byteBufferSlice.getInt() == 1896449818) {
                        X509Certificate[][] x509CertificateArrZzl = zzl(randomAccessFile.getChannel(), new zzaoj(zze(byteBufferSlice, i3 - 4), jLongValue2, jZza, jLongValue, byteBuffer, null));
    ...
    private static int zzb(int i) {
        ...
        throw new IllegalArgumentException(k31.k(i, "Unknown content digest algorthm: "));
    }
    ...
    private static ByteBuffer zzf(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() < 4) {
            throw new IOException(k31.k(byteBuffer.remaining(), "Remaining buffer too short to contain length of length-prefixed field. Remaining: "));
        }
        ...
        throw new IOException(k31.j(i, byteBuffer.remaining(), "Length-prefixed field longer than remaining buffer. Field length: ", ", remaining: "));
    }
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) {
        ...
        zzaoo.zzd(byteBufferDuplicate, j);
    ...
    private static byte[] zzi(ByteBuffer byteBuffer) throws IOException {
        ...
        if (i > byteBuffer.remaining()) {
            throw new IOException(k31.j(i, byteBuffer.remaining(), "Underflow while reading length-prefixed value. Length: ", ", available: "));
        }
    ...
    private static X509Certificate[] zzj(ByteBuffer byteBuffer, Map map, CertificateFactory certificateFactory) throws IOException {
        ...
        while (byteBufferZzf2.hasRemaining()) {
            ...
            try {
                ...
                e = e;
                throw new SecurityException(k31.k(i2, "Failed to parse signature record #"), e);
        ...
        try {
            ...
            while (byteBufferZzf4.hasRemaining()) {
                ...
                try {
                    ...
                    e = e3;
                    throw new IOException(k31.k(i4, "Failed to parse digest record #"), e);
            ...
            while (byteBufferZzf6.hasRemaining()) {
                ...
                try {
                    ...
                    throw new SecurityException(k31.k(i6, "Failed to decode certificate #"), e5);
                }
            }
            ...
            e = e6;
            throw new SecurityException(uo.t("Failed to verify ", str2, " signature"), e);
    ...
    private static byte[][] zzk(int[] iArr, zzaog[] zzaogVarArr) throws DigestException {
        ...
        while (true) {
            ...
            jZza += (zzaogVarArr[i4].zza() + 1048575) / 1048576;
            i4++;
        }
        if (jZza >= 2097151) {
            throw new DigestException(uo.f("Too many chunks: ", jZza));
        }
        ...
        while (i8 < i) {
            ...
            while (jZza2 > 0) {
                ...
                try {
                    zzaogVar.zzb(messageDigestArr, j2, iMin);
                    ...
                    throw new DigestException(k31.j(i11, i3, "Failed to digest chunk #", " of section #"), e2);
                }
            }
            i3++;
            i8 = i10 + 1;
            ...
            try {
                ...
                while (byteBufferZzf.hasRemaining()) {
                    ...
                    try {
                        ...
                        throw new SecurityException(uo.d(i, "Failed to parse/verify signer #", " block"), e);
                    }
                }
                if (i <= 0) {
