...
final class zzfxb {
    ...
    public static int zzb(Object obj, Object obj2, int i, Object obj3, int[] iArr, Object[] objArr, Object[] objArr2) {
        ...
        if (iZzc != 0) {
            ...
            while (true) {
                ...
                int i8 = iArr[i2];
                i3 = i8 & i;
                if ((i8 & i5) != i6 || !zzfur.zza(obj, objArr[i2]) || (objArr2 != null && !zzfur.zza(obj2, objArr2[i2]))) {
                    if (i3 == 0) {
                        break;
                    }
                    i7 = i2;
    ...
    public static Object zzd(int i) {
        if (i < 2 || i > 1073741824 || Integer.highestOneBit(i) != i) {
            throw new IllegalArgumentException(k31.k(i, "must be power of 2 between 2^1 and 2^30: "));
        }
