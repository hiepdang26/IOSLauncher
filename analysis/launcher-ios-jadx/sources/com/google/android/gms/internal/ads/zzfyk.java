...
abstract class zzfyk extends zzfzq {
    ...
    public boolean contains(Object obj) {
        if (obj instanceof Map.Entry) {
            ...
            Object objZza = zzfyo.zza(zza(), key);
            if (zzfur.zza(objZza, entry.getValue())) {
    ...
    public final boolean retainAll(Collection collection) {
        ...
        try {
            ...
            if (size < 3) {
                ...
                iCeil = size < 1073741824 ? (int) Math.ceil(((double) size) / 0.75d) : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            }
