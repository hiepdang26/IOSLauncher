...
final class zzahl {
    ...
    public final long zzd(zzacl zzaclVar, boolean z, boolean z2, int i) throws EOFException, InterruptedIOException {
        if (this.zzc == 0) {
            if (!zzaclVar.zzn(this.zzb, 0, 1, z)) {
                return -1L;
            }
        ...
        if (i2 != 1) {
            ((zzaby) zzaclVar).zzn(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
