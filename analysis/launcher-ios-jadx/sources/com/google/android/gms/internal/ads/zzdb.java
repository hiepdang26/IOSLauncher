...
public final class zzdb {
    ...
    public /* synthetic */ zzdb(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f, int i, int i2, float f2, int i3, int i4, float f3, float f4, float f5, boolean z, int i5, int i6, float f6, zzda zzdaVar) {
    ...
    public final Bundle zza() {
        ...
        if (charSequence != null) {
            ...
            if (charSequence2 instanceof Spanned) {
                ArrayList<? extends Parcelable> arrayListZza = zzdd.zza((Spanned) charSequence2);
