...
final class zzatl implements zzate {
    ...
    public final void zza(byte[] bArr, byte[] bArr2) {
        ...
        int i23 = (zzaudVar.zzC & (~i)) ^ zzaudVar.zzar;
        zzaudVar.zzC = i23;
        int i24 = (i23 ^ zzaudVar.zzJ) ^ zzaudVar.zzbG;
        int i25 = zzaudVar.zzbu;
        int i26 = i25 | i24;
        int i27 = zzaudVar.zzbV;
        int i28 = i27 ^ i26;
        zzaudVar.zzJ = i28;
        int i29 = i28 ^ zzaudVar.zzal;
        zzaudVar.zzal = i29;
        int i30 = zzaudVar.zzab ^ (i27 ^ (i25 & i24));
        zzaudVar.zzab = i30;
        int i31 = i2 ^ i;
        zzaudVar.zzbK = i31;
        ...
        int i33 = (i5 | i31) ^ i31;
        zzaudVar.zzbG = i33;
        int i34 = (((((zzaudVar.zzcc ^ i31) & i6) & i12) ^ i4) | i15) ^ i10;
        zzaudVar.zzcc = i34;
        int i35 = i34 ^ zzaudVar.zzf;
        zzaudVar.zzf = i35;
        int i36 = i5 ^ i31;
        zzaudVar.zzbs = i36;
        int i37 = zzaudVar.zzp ^ i36;
        zzaudVar.zzp = i37;
        int i38 = i37 ^ i32;
        zzaudVar.zzaN = i38;
        int i39 = i38 ^ zzaudVar.zzcC;
        zzaudVar.zzcC = i39;
        int i40 = ~(i39 ^ zzaudVar.zzbn);
        zzaudVar.zzbn = i40;
        int i41 = i36 ^ ((i31 ^ zzaudVar.zzan) & i6);
        zzaudVar.zzan = i41;
        int i42 = i41 ^ ((i33 ^ i22) & i12);
        zzaudVar.zzaC = i42;
        int i43 = (i18 & i19) ^ i42;
        zzaudVar.zzat = i43;
        int i44 = i43 ^ zzaudVar.zzbl;
        zzaudVar.zzbl = i44;
        int i45 = zzaudVar.zzaL;
        bArr2[0] = (byte) (i45 & 255);
        bArr2[1] = (byte) ((i45 >>> 8) & 255);
        bArr2[2] = (byte) ((i45 >>> 16) & 255);
        bArr2[3] = (byte) (i45 >> 24);
        int i46 = zzaudVar.zzce;
