...
final class zzfwb extends zzfwe implements NavigableMap {
    ...
    public final Map.Entry ceilingEntry(Object obj) {
        Map.Entry entryCeilingEntry = ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).ceilingEntry(obj);
    ...
    public final Map.Entry firstEntry() {
        Map.Entry entryFirstEntry = ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).firstEntry();
    ...
    public final Map.Entry floorEntry(Object obj) {
        Map.Entry entryFloorEntry = ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).floorEntry(obj);
    ...
    public final Map.Entry higherEntry(Object obj) {
        Map.Entry entryHigherEntry = ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).higherEntry(obj);
    ...
    public final Map.Entry lastEntry() {
        Map.Entry entryLastEntry = ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).lastEntry();
    ...
    public final Map.Entry lowerEntry(Object obj) {
        Map.Entry entryLowerEntry = ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).lowerEntry(obj);
    ...
    public final Map.Entry zzc(Iterator it) {
        ...
        it.remove();
        return new zzfxn(entry.getKey(), this.zzc.zzb(collectionZza));
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new zzfwb(this.zzc, ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).headMap(obj, z));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfwb(this.zzc, ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).subMap(obj, z, obj2, z2));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap tailMap(Object obj, boolean z) {
        return new zzfwb(this.zzc, ((NavigableMap) ((SortedMap) ((zzfvx) this).zza)).tailMap(obj, z));
    }
}
