...
public final class zzgvo implements zzgem {
    ...
    private zzgvo(zzgov zzgovVar) {
        String strValueOf = String.valueOf(zzgovVar.zzb().zzf());
        this.zzb = new zzgvn("HMAC".concat(strValueOf), new SecretKeySpec(zzgovVar.zzd().zzd(zzgdx.zza()), "HMAC"));
    ...
    public zzgvo(zzgqi zzgqiVar, int i) {
        this.zzb = zzgqiVar;
        this.zzc = i;
        this.zzd = new byte[0];
        this.zze = new byte[0];
