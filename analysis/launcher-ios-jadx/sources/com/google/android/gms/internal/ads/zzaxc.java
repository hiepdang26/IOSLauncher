...
public final class zzaxc {
    ...
    public static /* bridge */ /* synthetic */ void zzb(zzaxc zzaxcVar) {
        try {
            ...
            Class<?> clsLoadClass = zzavpVar.zzi().loadClass(zzaxcVar.zzc(zzavpVar.zzu(), zzaxcVar.zzb));
            if (clsLoadClass != null) {
                zzaxcVar.zzd = clsLoadClass.getMethod(zzaxcVar.zzc(zzaxcVar.zza.zzu(), zzaxcVar.zzc), zzaxcVar.zze);
            }
