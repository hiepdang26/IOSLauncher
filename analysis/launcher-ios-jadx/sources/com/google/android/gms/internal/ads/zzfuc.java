                ...
                try {
                    ...
                    if (signatureArr == null || (signatureArr.length) == 0) {
                        ...
                        for (Signature signature : signatureArr) {
                            String strZza = zzfub.zza(signature.toByteArray());
                        ...
                        zzfuaVar.zzd(uo.t("Play Store package certs are not valid. Found these sha256 certs: [", sb.toString(), "]."), new Object[0]);
                    }
