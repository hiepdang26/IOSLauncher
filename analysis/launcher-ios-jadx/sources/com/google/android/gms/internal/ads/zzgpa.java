...
public final class zzgpa {
    ...
    public static void zza(boolean z) throws GeneralSecurityException {
        ...
        map.put("HMAC_SHA256_128BITTAG", zzgpt.zza);
        ...
        map.put("HMAC_SHA256_128BITTAG_RAW", zzgpcVar.zze());
        ...
        map.put("HMAC_SHA256_256BITTAG", zzgpcVar2.zze());
        zzgpc zzgpcVar3 = new zzgpc(null);
        zzgpcVar3.zzb(32);
        zzgpcVar3.zzc(32);
        zzgpcVar3.zzd(zzgpeVar);
        zzgpcVar3.zza(zzgpdVar);
        map.put("HMAC_SHA256_256BITTAG_RAW", zzgpcVar3.zze());
