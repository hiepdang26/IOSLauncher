...
final class zznp {
    ...
    private static zzui zzj(zzbw zzbwVar, zzfxr zzfxrVar, zzui zzuiVar, zzca zzcaVar) {
        ...
        for (int i = 0; i < zzfxrVar.size(); i++) {
            zzui zzuiVar2 = (zzui) zzfxrVar.get(i);
            if (zzm(zzuiVar2, objZzf, zzbwVar.zzw(), zzbwVar.zzb(), zzbwVar.zzc(), iZzc)) {
                return zzuiVar2;
            }
        }
        if (zzfxrVar.isEmpty() && zzuiVar != null && zzm(zzuiVar, objZzf, zzbwVar.zzw(), zzbwVar.zzb(), zzbwVar.zzc(), iZzc)) {
            return zzuiVar;
        }
        return null;
    }
    ...
    private final void zzl(zzcc zzccVar) {
        ...
        if (this.zzb.isEmpty()) {
            ...
            for (int i = 0; i < this.zzb.size(); i++) {
                zzk(zzfxtVar, (zzui) this.zzb.get(i), zzccVar);
            }
    ...
    private static boolean zzm(zzui zzuiVar, Object obj, boolean z, int i, int i2, int i3) {
        if (zzuiVar.zza.equals(obj)) {
            return z ? zzuiVar.zzb == i && zzuiVar.zzc == i2 : zzuiVar.zzb == -1 && zzuiVar.zze == i3;
        }
        return false;
    }
