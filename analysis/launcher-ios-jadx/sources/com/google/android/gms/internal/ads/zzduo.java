...
public final class zzduo implements zzhfc {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        WeakReference weakReferenceZza = ((zzcgq) this.zzc).zza();
        zzgcu zzgcuVar = zzbzo.zza;
        zzhfk.zzb(zzgcuVar);
        return new zzdun(executor, contextZza, weakReferenceZza, zzgcuVar, (zzdqb) this.zzd.zzb(), (ScheduledExecutorService) this.zze.zzb(), (zzdsu) this.zzf.zzb(), ((zzchc) this.zzg).zza(), ((zzddq) this.zzh).zzb(), (zzfki) this.zzi.zzb());
    }
}
