...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        public void readField(Object[] objArr, JsonReader jsonReader, BoundField boundField) {
            ...
            throw new IllegalStateException(uo.k(sb, boundField.fieldName, "', unable to determine which argument in the constructor the field corresponds to. This is unexpected behavior, as we expect the RecordComponents to have the same names as the fields in the Java class, and that the order of the RecordComponents is the same as the order of the canonical constructor parameters."));
        }
    }
    ...
    public static <M extends AccessibleObject & Member> void checkAccessible(Object obj, M m) {
        ...
        if (!ReflectionAccessFilterHelper.canAccess(m, obj)) {
            throw new JsonIOException(uo.h(ReflectionHelper.getAccessibleObjectDescription(m, true), " is not accessible and ReflectionAccessFilter does not permit making it accessible. Register a TypeAdapter for the declaring type, adjust the access filter or increase the visibility of the element and its declaring type."));
        }
    }
                ...
                if (this.serialized) {
                    ...
                    if (method3 != null) {
                        try {
                            ...
                            throw new JsonIOException(uo.t("Accessor ", ReflectionHelper.getAccessibleObjectDescription(method, false), " threw exception"), e.getCause());
                        }
                    } else {
                    ...
                    if (zIncludeField || zIncludeField2) {
                        if (!z2) {
                            ...
                            if (accessor.getAnnotation(SerializedName.class) != null && field.getAnnotation(SerializedName.class) == null) {
                                throw new JsonIOException(uo.t("@SerializedName on ", ReflectionHelper.getAccessibleObjectDescription(accessor, z6), " is not supported"));
                            }
                            i = i5;
                            method = accessor;
                            z3 = zIncludeField2;
