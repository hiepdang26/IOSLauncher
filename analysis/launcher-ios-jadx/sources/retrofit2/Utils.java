...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return uo.k(new StringBuilder(), Utils.typeToString(this.componentType), "[]");
        }
    }
    ...
    public static vb1 buffer(vb1 vb1Var) {
        fe feVar = new fe();
        vb1Var.source().f(feVar);
        return vb1.create(vb1Var.contentType(), vb1Var.contentLength(), feVar);
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbL = uo.l(i, "Index ", " not in range [0,");
        sbL.append(actualTypeArguments.length);
        sbL.append(") for ");
        sbL.append(parameterizedType);
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        StringBuilder sbM = k31.m(str, " (parameter #");
        sbM.append(i + 1);
        sbM.append(")");
        return methodError(method, th, sbM.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder sbM = k31.m(String.format(str, objArr), "\n    for method ");
        sbM.append(method.getDeclaringClass().getSimpleName());
        sbM.append(".");
        sbM.append(method.getName());
        return new IllegalArgumentException(sbM.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        ...
        sbM.append(i + 1);
        sbM.append(")");
        return methodError(method, sbM.toString(), objArr);
    }
}
