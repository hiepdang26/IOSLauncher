...
final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private ob0 parseHeaders(String[] strArr) {
            nb0 nb0Var = new nb0();
            for (String str : strArr) {
                ...
                if ("Content-Type".equalsIgnoreCase(strSubstring)) {
                    try {
                        this.contentType = ks0.a(strTrim);
                    } catch (IllegalArgumentException e) {
                        throw Utils.methodError(this.method, e, "Malformed content type: %s", strTrim);
                    }
                } else {
                    ob0.a(strSubstring);
                    ob0.b(strTrim, strSubstring);
                    nb0Var.a(strSubstring, strTrim);
                }
            }
        ...
        private ParameterHandler<?> parseParameter(int i, Type type, Annotation[] annotationArr, boolean z) {
            ...
            if (z) {
                try {
                    if (Utils.getRawType(type) == eo.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                this.gotUrl = true;
                if (type == od0.class || type == String.class || type == URI.class || ((type instanceof Class) && "android.net.Uri".equals(((Class) type).getName()))) {
            ...
            if (annotation instanceof Part) {
                ...
                if (strValue5.isEmpty()) {
                    if (!Iterable.class.isAssignableFrom(rawType8)) {
                        if (rawType8.isArray()) {
                            if (hv0.class.isAssignableFrom(rawType8.getComponentType())) {
                        ...
                        if (hv0.class.isAssignableFrom(rawType8)) {
                            return ParameterHandler.RawPart.INSTANCE;
                        }
                        throw Utils.parameterError(this.method, i, "@Part annotation must supply a name or use MultipartBody.Part parameter type.", new Object[0]);
                    }
                    if (type instanceof ParameterizedType) {
                        if (hv0.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                ...
                ob0 ob0VarF = ob0.f("Content-Disposition", uo.t("form-data; name=\"", strValue5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (!Iterable.class.isAssignableFrom(rawType8)) {
                    if (!rawType8.isArray()) {
                        if (hv0.class.isAssignableFrom(rawType8)) {
                        ...
                        return new ParameterHandler.Part(this.method, i, ob0VarF, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                    }
                    Class<?> clsBoxIfPrimitive = boxIfPrimitive(rawType8.getComponentType());
                    if (hv0.class.isAssignableFrom(clsBoxIfPrimitive)) {
                        throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    }
                    return new ParameterHandler.Part(this.method, i, ob0VarF, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                }
                if (type instanceof ParameterizedType) {
                    Type parameterUpperBound4 = Utils.getParameterUpperBound(0, (ParameterizedType) type);
                    if (hv0.class.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                        throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    }
                    return new ParameterHandler.Part(this.method, i, ob0VarF, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                }
                throw Utils.parameterError(this.method, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
            }
            if (annotation instanceof PartMap) {
                ...
                if (String.class == parameterUpperBound5) {
                    ...
                    if (hv0.class.isAssignableFrom(Utils.getRawType(parameterUpperBound6))) {
    ...
    public ia1 create(Object[] objArr) {
        ParameterHandler<?>[] parameterHandlerArr = this.parameterHandlers;
        int length = objArr.length;
        if (length != parameterHandlerArr.length) {
            throw new IllegalArgumentException(uo.j(uo.l(length, "Argument count (", ") doesn't match expected count ("), parameterHandlerArr.length, ")"));
        }
        ...
        ga1 ga1Var = requestBuilder.get();
        ga1Var.d(Invocation.class, new Invocation(this.method, arrayList));
        return ga1Var.a();
    }
}
