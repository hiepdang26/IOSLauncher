...
public class NestedScrollView extends FrameLayout implements xw0 {
    public static final float J = (float) (Math.log(0.78d) / Math.log(0.9d));
    public static final cr0 K = new cr0(2);
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, m41.nestedScrollViewStyle);
    }
    ...
    private ne1 getScrollFeedbackProvider() {
        if (this.m == null) {
            this.m = new ne1(this);
        }
        return this.m;
    ...
    public final boolean a(int i) {
        ...
        if (view != null && view.isFocused() && !g(view, 0, getHeight())) {
            ...
            setDescendantFocusability(ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CACHE_FILE_EXISTS_BUT_CANNOT_BE_READ);
            requestFocus();
    ...
    */
    ...
    public final void d(int i) {
        if (getChildCount() > 0) {
            this.j.fling(getScrollX(), getScrollY(), 0, i, 0, 0, RtlSpacingHelper.UNDEFINED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, 0, 0);
            this.F.g(2, 1);
            this.C = getScrollY();
            postInvalidateOnAnimation();
            if (Build.VERSION.SDK_INT >= 35) {
                sw0.a(this, Math.abs(this.j.getCurrVelocity()));
            }
        }
    }
    ...
    public final boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return this.F.c(i, i2, 0, iArr, iArr2);
    }

    @Override // android.view.View
    public final boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.F.d(i, i2, i3, i4, iArr, 0, null);
    }
    ...
    public final void h(int[] iArr, int i, int i2) {
        ...
        this.F.d(0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
    ...
    public final boolean j(int i, int i2, int i3, int i4) {
        ...
        if (z2 && !this.F.f(1)) {
            this.j.springBack(i5, i6, 0, 0, 0, getScrollRange());
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean l(int r19, int r20, int r21) {
        /*
            r18 = this;
            r0 = r19
            r1 = r20
    ...
    */
    ...
    public final boolean n(EdgeEffect edgeEffect, int i) {
        ...
        float fS = wd.s(edgeEffect) * getHeight();
    ...
    public final void o(int i, int i2, boolean z) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.h > 250) {
            ...
            int scrollY = getScrollY();
            this.j.startScroll(getScrollX(), scrollY, 0, Math.max(0, Math.min(i2 + scrollY, Math.max(0, height - height2))) - scrollY, 250);
            if (z) {
                this.F.g(2, 1);
            } else {
                q(1);
    ...
    */
    ...
    public final Parcelable onSaveInstanceState() {
        uw0 uw0Var = new uw0(super.onSaveInstanceState());
        uw0Var.g = getScrollY();
        return uw0Var;
    }
    ...
    public void onScrollChanged(int i, int i2, int i3, int i4) {
        ...
        tw0 tw0Var = this.H;
        if (tw0Var != null) {
            tw0Var.onScrollChange(this, i, i2, i3, i4);
        }
    }
    ...
    */
    ...
    public final boolean p(MotionEvent motionEvent) {
        boolean z;
        EdgeEffect edgeEffect = this.k;
        if (wd.s(edgeEffect) != 0.0f) {
            wd.y(edgeEffect, 0.0f, motionEvent.getX() / getWidth());
            z = true;
        } else {
            z = false;
        }
        EdgeEffect edgeEffect2 = this.l;
        if (wd.s(edgeEffect2) == 0.0f) {
            return z;
        }
        wd.y(edgeEffect2, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    public void setOnScrollChangeListener(tw0 tw0Var) {
        this.H = tw0Var;
    }
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.z = new int[2];
        this.A = new int[2];
        this.I = new fv(getContext(), new nx0(this, 20));
        int i2 = Build.VERSION.SDK_INT;
        this.k = i2 >= 31 ? hy.a(context, attributeSet) : new EdgeEffect(context);
        this.l = i2 >= 31 ? hy.a(context, attributeSet) : new EdgeEffect(context);
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, L, i, 0);
