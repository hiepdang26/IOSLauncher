...
public class AppCompatButton extends Button implements aa, ao1, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mAutoSizeTextTypeId = propertyMapper.mapIntEnum("autoSizeTextType", r41.autoSizeTextType, new IntFunction<String>() { // from class: androidx.appcompat.widget.AppCompatButton.InspectionCompanion.1
    ...
    public AppCompatButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, r41.buttonStyle);
    }
