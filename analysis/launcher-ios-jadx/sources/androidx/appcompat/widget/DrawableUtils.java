...
public class DrawableUtils {
    ...
    public static boolean canSafelyMutateDrawable(Drawable drawable) {
        if (!(drawable instanceof DrawableContainer)) {
            if (drawable instanceof g02) {
                return canSafelyMutateDrawable(((h02) ((g02) drawable)).l);
            }
            if (drawable instanceof gx) {
                return canSafelyMutateDrawable(((gx) drawable).getWrappedDrawable());
            }
    ...
    public static Rect getOpticalBounds(Drawable drawable) {
        ...
        boolean z = drawable instanceof g02;
        Drawable drawable2 = drawable;
        if (z) {
            drawable2 = ((h02) ((g02) drawable)).l;
        }
        return Api18Impl.getOpticalInsets(drawable2);
    }
