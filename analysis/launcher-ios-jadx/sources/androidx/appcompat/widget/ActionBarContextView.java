...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(n61.abc_action_bar_title_item, this);
            LinearLayout linearLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleLayout = linearLayout;
            this.mTitleView = (TextView) linearLayout.findViewById(w51.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(w51.action_bar_subtitle);
    ...
    public void initForMode(final j1 j1Var) {
        ...
        View viewFindViewById = this.mClose.findViewById(w51.action_mode_close_button);
        ...
        gt0VarC.b(this.mActionMenuPresenter, this.mPopupContext);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            ...
            int i4 = i3 != -2 ? 1073741824 : RtlSpacingHelper.UNDEFINED;
            if (i3 >= 0) {
                paddingLeft = Math.min(i3, paddingLeft);
            }
            int i5 = layoutParams.height;
            int i6 = i5 == -2 ? RtlSpacingHelper.UNDEFINED : 1073741824;
            if (i5 >= 0) {
    ...
    @Override // androidx.appcompat.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ zt1 setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, r41.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, q71.ActionMode, i, 0);
        Drawable drawable = tintTypedArrayObtainStyledAttributes.getDrawable(q71.ActionMode_background);
        WeakHashMap weakHashMap = qs1.a;
        setBackground(drawable);
        this.mTitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(q71.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(q71.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = tintTypedArrayObtainStyledAttributes.getLayoutDimension(q71.ActionMode_height, 0);
        this.mCloseItemLayout = tintTypedArrayObtainStyledAttributes.getResourceId(q71.ActionMode_closeItemLayout, n61.abc_action_mode_close_item_material);
