...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(w51.action_bar);
        this.mContextView = findViewById(w51.action_context_bar);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView == null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE && (i3 = this.mHeight) >= 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(Math.min(i3, View.MeasureSpec.getSize(i2)), RtlSpacingHelper.UNDEFINED);
        }
    ...
    public void setTransitioning(boolean z) {
        ...
        setDescendantFocusability(z ? 393216 : ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_UNSUPPORTED_API_VERSION);
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, q71.ActionBar);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(q71.ActionBar_background);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(q71.ActionBar_backgroundStacked);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(q71.ActionBar_height, -1);
        boolean z = true;
        if (getId() == w51.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(q71.ActionBar_backgroundSplit);
        }
