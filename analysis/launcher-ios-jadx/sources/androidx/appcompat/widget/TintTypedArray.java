...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        ...
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (colorStateListM = hg0.m(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i) : colorStateListM;
    }
    ...
    public Drawable getDrawable(int i) {
        int resourceId;
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0) ? this.mWrapped.getDrawable(i) : hg0.o(this.mContext, resourceId);
    }
    ...
    public Typeface getFont(int i, int i2, qb1 qb1Var) {
        ...
        return rb1.c(context, resourceId, typedValue, i2, qb1Var, true, false);
    }
