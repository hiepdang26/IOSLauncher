...
class SuggestionsAdapter extends hb1 implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(w51.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(r41.textColorSearchUrl, typedValue, true);
    ...
    public Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        if (TextUtils.isEmpty(authority)) {
            throw new FileNotFoundException(k31.l(uri, "No authority: "));
        }
        try {
            ...
            if (pathSegments == null) {
                throw new FileNotFoundException(k31.l(uri, "No path: "));
            }
            ...
            if (size == 1) {
                try {
                    ...
                    throw new FileNotFoundException(k31.l(uri, "Single path segment is not a resource ID: "));
                }
            } else {
                if (size != 2) {
                    throw new FileNotFoundException(k31.l(uri, "More than two path segments: "));
                }
            ...
            throw new FileNotFoundException(k31.l(uri, "No resource found for: "));
        } catch (PackageManager.NameNotFoundException unused2) {
            throw new FileNotFoundException(k31.l(uri, "No package found for authority: "));
        }
    }

    @Override // defpackage.kq, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    ...
    @Override // defpackage.hb1, defpackage.kq
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View viewNewView = super.newView(context, cursor, viewGroup);
        viewNewView.setTag(new ChildViewCache(viewNewView));
        ((ImageView) viewNewView.findViewById(w51.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
