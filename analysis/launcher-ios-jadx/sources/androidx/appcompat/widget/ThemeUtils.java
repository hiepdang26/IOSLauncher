...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(q71.AppCompatTheme);
        try {
    ...
    public static int getThemeAttrColor(Context context, int i, float f) {
        return ik.h(getThemeAttrColor(context, i), Math.round(Color.alpha(r0) * f));
    }
}
