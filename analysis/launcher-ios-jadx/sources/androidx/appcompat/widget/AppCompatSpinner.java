...
public class AppCompatSpinner extends Spinner {
    ...
    public class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show(int i, int i2) {
            ...
            t3 t3Var = new t3(AppCompatSpinner.this.getPopupContext());
            ...
            p3Var.r = listAdapter;
            p3Var.s = this;
            p3Var.x = selectedItemPosition;
            p3Var.w = true;
            u3 u3VarD = t3Var.d();
            this.mPopup = u3VarD;
            AlertController$RecycleListView alertController$RecycleListView = u3VarD.i.f;
    ...
    public static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && i0.v(spinnerAdapter)) {
                    android.widget.ThemedSpinnerAdapter themedSpinnerAdapterO = i0.o(spinnerAdapter);
                    if (themedSpinnerAdapterO.getDropDownViewTheme() != theme) {
                        themedSpinnerAdapterO.setDropDownViewTheme(theme);
                        return;
                    }
                    return;
                }
    ...
    public void setPopupBackgroundResource(int i) {
        setPopupBackgroundDrawable(hg0.o(getPopupContext(), i));
    }
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, r41.spinnerStyle, i);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, r41.spinnerStyle);
    }
