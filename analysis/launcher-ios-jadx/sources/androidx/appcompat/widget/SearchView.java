...
public class SearchView extends LinearLayoutCompat implements uj {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", r41.iconifiedByDefault);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", r41.queryHint);
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i >= 960 && i2 >= 720 && configuration.orientation == 2) {
                return MotionScene.Transition.TransitionOnClick.JUMP_TO_END;
            }
            if (i < 600) {
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(f51.abc_search_view_preferred_height);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(f51.abc_search_view_preferred_width);
    }
    ...
    private boolean hasVoiceSearch() {
        ...
        if (searchableInfo != null && searchableInfo.getVoiceSearchEnabled()) {
            ...
            if (intent != null && getContext().getPackageManager().resolveActivity(intent, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_PACKAGE_NAME_DOES_NOT_EXIST) != null) {
                return true;
            }
        }
        return false;
    ...
    private void updateSearchAutoComplete() {
        ...
        kq kqVar = this.mSuggestionsAdapter;
        if (kqVar != null) {
            kqVar.changeCursor(null);
        }
        if (this.mSearchable.getSuggestAuthority() != null) {
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(f51.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(f51.abc_dropdownitem_icon_width) : 0;
    ...
    public kq getSuggestionsAdapter() {
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        kq kqVar = this.mSuggestionsAdapter;
        if (kqVar instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) kqVar).setQueryRefinement(z ? 2 : 1);
        }
    }
    ...
    public void setSuggestionsAdapter(kq kqVar) {
        this.mSuggestionsAdapter = kqVar;
        this.mSearchSrcTextView.setAdapter(kqVar);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, r41.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mReleaseCursorRunnable = new Runnable() { // from class: androidx.appcompat.widget.SearchView.2
            @Override // java.lang.Runnable
            public void run() {
                kq kqVar = SearchView.this.mSuggestionsAdapter;
                if (kqVar instanceof SuggestionsAdapter) {
                    kqVar.changeCursor(null);
                }
            }
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, q71.SearchView, i, 0);
        qs1.o(this, context, q71.SearchView, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i);
        LayoutInflater.from(context).inflate(tintTypedArrayObtainStyledAttributes.getResourceId(q71.SearchView_layout, n61.abc_search_view), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(w51.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(w51.search_edit_frame);
        View viewFindViewById = findViewById(w51.search_plate);
        this.mSearchPlate = viewFindViewById;
        View viewFindViewById2 = findViewById(w51.submit_area);
        this.mSubmitArea = viewFindViewById2;
        ImageView imageView = (ImageView) findViewById(w51.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(w51.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(w51.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(w51.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(w51.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        viewFindViewById.setBackground(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_queryBackground));
        viewFindViewById2.setBackground(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_submitBackground));
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_searchIcon));
        imageView2.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_goIcon));
        imageView3.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_closeIcon));
        imageView4.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_voiceIcon));
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_searchIcon));
        this.mSearchHintIcon = tintTypedArrayObtainStyledAttributes.getDrawable(q71.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(x61.abc_searchview_description_search));
        this.mSuggestionRowLayout = tintTypedArrayObtainStyledAttributes.getResourceId(q71.SearchView_suggestionRowLayout, n61.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = tintTypedArrayObtainStyledAttributes.getResourceId(q71.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(tintTypedArrayObtainStyledAttributes.getBoolean(q71.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(q71.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = tintTypedArrayObtainStyledAttributes.getText(q71.SearchView_defaultQueryHint);
        this.mQueryHint = tintTypedArrayObtainStyledAttributes.getText(q71.SearchView_queryHint);
        int i2 = tintTypedArrayObtainStyledAttributes.getInt(q71.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = tintTypedArrayObtainStyledAttributes.getInt(q71.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(tintTypedArrayObtainStyledAttributes.getBoolean(q71.SearchView_android_focusable, true));
