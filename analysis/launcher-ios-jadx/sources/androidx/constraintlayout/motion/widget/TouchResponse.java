...
class TouchResponse {
    ...
    private void fill(TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == j71.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = typedArray.getResourceId(index, this.mTouchAnchorId);
            } else if (index == j71.OnSwipe_touchAnchorSide) {
            ...
            } else if (index == j71.OnSwipe_dragDirection) {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, j71.OnSwipe);
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i, MotionScene motionScene) {
        ...
        if (Math.abs((this.mTouchDirectionY * rawY) + (this.mTouchDirectionX * rawX)) > this.mDragThreshold || this.mDragStarted) {
            ...
            if (Math.abs(((this.mTouchDirectionY * fArr4[c2]) + (f5 * fArr4[c3])) * this.mDragScale) < 0.01d) {
    ...
    */
    ...
    public void setupTouch() {
        ...
        if (viewFindViewById instanceof NestedScrollView) {
            ...
            nestedScrollView.setOnScrollChangeListener(new tw0() { // from class: androidx.constraintlayout.motion.widget.TouchResponse.2
