...
public class DesignTool {
    ...
    private static void connect(int i, en enVar, View view, HashMap<String, String> map, int i2, int i3) {
        String str = sAllAttributes.get(Pair.create(Integer.valueOf(i2), Integer.valueOf(i3)));
        String str2 = map.get(str);
        if (str2 != null) {
            String str3 = sAllMargins.get(str);
            enVar.g(view.getId(), i2, Integer.parseInt(str2), i3, str3 != null ? getPxFromDp(i, map.get(str3)) : 0);
        }
    }
    ...
    private static void setAbsolutePositions(int i, en enVar, View view, HashMap<String, String> map) {
        String str = map.get("layout_editor_absoluteX");
        if (str != null) {
            enVar.k(view.getId()).e.D = getPxFromDp(i, str);
        }
        String str2 = map.get("layout_editor_absoluteY");
        if (str2 != null) {
            enVar.k(view.getId()).e.E = getPxFromDp(i, str2);
        }
    }

    private static void setBias(en enVar, View view, HashMap<String, String> map, int i) {
        String str = map.get(i == 1 ? "layout_constraintVertical_bias" : "layout_constraintHorizontal_bias");
        if (str != null) {
            if (i == 0) {
                enVar.k(view.getId()).e.x = Float.parseFloat(str);
            } else if (i == 1) {
                enVar.k(view.getId()).e.y = Float.parseFloat(str);
            }
        }
    }

    private static void setDimensions(int i, en enVar, View view, HashMap<String, String> map, int i2) {
        String str = map.get(i2 == 1 ? "layout_height" : "layout_width");
        if (str != null) {
            int pxFromDp = !str.equalsIgnoreCase("wrap_content") ? getPxFromDp(i, str) : -2;
            if (i2 == 0) {
                enVar.k(view.getId()).e.c = pxFromDp;
            } else {
                enVar.k(view.getId()).e.d = pxFromDp;
            }
        }
    }
    ...
    public void dumpConstraintSet(String str) {
        ...
        try {
            this.mMotionLayout.mScene.getConstraintSet(iLookUpConstraintId).i(this.mMotionLayout.mScene, new int[0]);
    ...
    public void setAttributes(int i, String str, Object obj, Object obj2) {
        ...
        en constraintSet = this.mMotionLayout.mScene.getConstraintSet(iLookUpConstraintId);
        if (constraintSet == null) {
            return;
        }
        constraintSet.g.remove(Integer.valueOf(view.getId()));
