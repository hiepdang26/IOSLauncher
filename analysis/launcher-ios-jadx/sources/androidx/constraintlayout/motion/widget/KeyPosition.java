...
public class KeyPosition extends KeyPositionBase {
    ...
    public static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(j71.KeyPosition_motionTarget, 1);
            sAttrMap.append(j71.KeyPosition_framePosition, 2);
            sAttrMap.append(j71.KeyPosition_transitionEasing, 3);
            sAttrMap.append(j71.KeyPosition_curveFit, 4);
            sAttrMap.append(j71.KeyPosition_drawPath, 5);
            sAttrMap.append(j71.KeyPosition_percentX, 6);
            sAttrMap.append(j71.KeyPosition_percentY, 7);
            sAttrMap.append(j71.KeyPosition_keyPositionType, 9);
            sAttrMap.append(j71.KeyPosition_sizePercent, 8);
            sAttrMap.append(j71.KeyPosition_percentWidth, 11);
            sAttrMap.append(j71.KeyPosition_percentHeight, 12);
            sAttrMap.append(j71.KeyPosition_pathMotionArc, 10);
        }
                ...
                switch (sAttrMap.get(index)) {
                    ...
                    case 3:
                        if (typedArray.peekValue(index).type == 3) {
                            ...
                            keyPosition.mTransitionEasing = fy.c[typedArray.getInteger(index, 0)];
                        }
                        break;
                    case 4:
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, j71.KeyPosition));
    }
